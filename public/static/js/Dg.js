...
$(function ($) {
    $('#dg').datagrid({
        ...
        columns: [[
            ...
            {field: 'card', title: '身份证号', width: '12%', sortable: true},
            {field: 'tel', title: '电话', width: '8%', sortable: true},
            {field: 'mode', title: '入户方式', align: 'center', width: '5%', sortable: true},
            {field: 'status', title: '工作流', width: '5%', sortable: true},
            // {field:'education',title:'学历',width:'3%'},
            {field: 'shebao', title: '社保', align: 'center', width: '4%', sortable: true},
            {field: 'service', title: '窗口', width: '7%', sortable: true},
            //{field:'marriage',title:'婚姻',align:'center',width:'4%'},
            {field: 'speed', title: '进度', align: 'center', width: '6%', sortable: true},
            {field: 'user_name', title: '业务员', width: '4%', sortable: true},
            //{field:'add_time',title:'添加时间',width:'7%'},
            {field: 'dangan', title: '调档', width: '2%', align: 'center', sortable: true},
            //{field:'rcdate',title:'预约时间',width:'9%',sortable:true},
            {field: 'rcdate', title: '人才网时间', width: '9%', sortable: true},
            {field: 'Tag', title: '标签', width: "12%", sortable: true},
            {field: 'comment', title: '备注', width: '10%', sortable: true},
            ...
            {field: 'sbtype', title: '申报类型', width: '5%', sortable: true},
            //{field:'speed_time',title:'进度日期',width:'7%'},
            {field: 'shebaoname', title: '社保公司', width: '15%', sortable: true},
        ]],
