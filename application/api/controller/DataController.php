...
class DataController extends Base
{
    ...
    {
        $data = Data::get($id);
        return $data->sign() ? Res::Json(200) : Res::Json(400, $data->error);
    }
    ...
    {
        $data = Data::get($id);
        return $data->submit() ? Res::Json(200) : Res::Json(400, $data->error);
    }
    ...
    {
        $data = Data::get($id);
        return $data->takeDiaol() ? Res::Json(200) : Res::Json(400, $data->error);
    }
    ...
    public function NuserCallin($id)
    {
        ...
        $data->nuser_id = $this->uid;
        $data->status = Data::ETCINPUT;
        return $data->save() ? Res::Json(200, '成功调入!') : Res::Json(400);
    }
